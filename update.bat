rem update.bat
rem Description: batch file to automatically sync git repository
rem Dependencies: MinGit Installed [MinGit](https://github.com/evansendra/mingit)
rem Usage: Double click to execute or call in a Command Line console .\update.bat
...
%GIT_PATH% remote add origin https://github.com/DSPBluePrints/MechaBluePrints.git
